...
var tr = document.createElement('tr');
        ...
        td1.innerHTML = '<input type="text" value=""/>'
        tr.appendChild(td1);

        td2 = document.createElement('td');
        td2.innerHTML = '<select id="jiuzhen_parent'+i+'" onchange="jiuzhen_clickOpt(this.id)"><option value="">请选择</option><option value="1">初诊</option><option value="2">复诊</option></select>'
        tr.appendChild(td2);

        td3 = document.createElement('td');
        td3.innerHTML = '<select id="jiuzhen_child'+i+'"><option>请选择初复诊</option></select>'
        tr.appendChild(td3);

        td4 = document.createElement('td');
        td4.innerHTML = '<select name="keshi" id="keshi_parent'+i+'" onchange="keshi_clickOpt(this.id)"><option value="">请选择</option><option value="1">内科</option><option value="2">外科</option><option value="3">男科</option><option value="4">妇科</option><option value="5">产科</option><option value="6">耳鼻喉</option><option value="7">疼痛科</option><option value="8">中医</option><option value="9">其他</option></select>'
        tr.appendChild(td4);

        td5 = document.createElement('td');
        td5.innerHTML = '<select id="zhenshi_child'+i+'"><option>请选择科室</option></select>'
        tr.appendChild(td5);

        td6 = document.createElement('td');
        td6.innerHTML = '<select id="bingzhong_child'+i+'"><option>请选择科室</option></select>'
        tr.appendChild(td6);

        td7 = document.createElement('td');
        td7.innerHTML = '<select><option>网络</option><option>电话</option><option>QQ</option><option>杂志</option><option>市场</option><option>持卡</option><option>路过</option><option>附近</option><option>介绍</option><option>来过</option><option>会员证</option></select>'
        tr.appendChild(td7);

        td8 = document.createElement('td');
        td8.innerHTML = '<input type="text" size="4"/>'
        tr.appendChild(td8);

        td9 = document.createElement('td');
        td9.innerHTML = '<select><option>男</option><option>女</option></select>'
        tr.appendChild(td9);

        td10 = document.createElement('td');
        td10.innerHTML = '<select><option>县城</option><option>广顺</option><option>杜家坝</option></select>'
        tr.appendChild(td10);

        td11 = document.createElement('td');
        td11.innerHTML = '<select><option>是</option><option selected="selected">否</option></select>'
        tr.appendChild(td11);

        td12 = document.createElement('td');
        td12.innerHTML = '<select><option>是</option><option selected="selected">否</option></select>'
        tr.appendChild(td12);

        td13 = document.createElement('td');
        td13.innerHTML = '<input type="text" size="8"/>'
        tr.appendChild(td13);

        td14 = document.createElement('td');
        td14.innerHTML = '<select><option>是</option><option selected="selected">否</option></select>'
        tr.appendChild(td14);

        td15 = document.createElement('td');
        td15.innerHTML = '<input type="text" size="8" />'
        tr.appendChild(td15);

        td16 = document.createElement('td');
        td16.innerHTML = '<input type="text" size="8" />'
        tr.appendChild(td16);
