...
var tr = document.createElement('tr');
        ...
        td1.innerHTML = '<input type="text" name="yiyuan'+i+'"/>';
        tr.appendChild(td1);

        td2 = document.createElement('td');
        td2.innerHTML = '<select id="jiuzhen_parent'+i+'" name="jiuzhen_parent'+i+'" onchange="jiuzhen_clickOpt(this.id)"><option value="">请选择</option><option value="1">初诊</option><option value="2">复诊</option></select>';
        tr.appendChild(td2);

        td3 = document.createElement('td');
        td3.innerHTML = '<select id="jiuzhen_child'+i+'" name="jiuzhen_child'+i+'"><option>请选择初复诊</option></select>';
        tr.appendChild(td3);

        td4 = document.createElement('td');
        td4.innerHTML = '<select id="keshi_parent'+i+'" name="keshi_parent'+i+'" onchange="keshi_clickOpt(this.id)"><option value="">请选择</option><option value="1">内科</option><option value="2">外科</option><option value="3">男科</option><option value="4">妇科</option><option value="5">产科</option><option value="6">耳鼻喉</option><option value="7">疼痛科</option><option value="8">中医</option><option value="9">其他</option></select>';
        tr.appendChild(td4);

        td5 = document.createElement('td');
        td5.innerHTML = '<select id="zhenshi_child'+i+'" name="zhenshi_child'+i+'"><option>请选择科室</option></select>';
        tr.appendChild(td5);

        td6 = document.createElement('td');
        td6.innerHTML = '<select id="bingzhong_child'+i+'" name="bingzhong_child'+i+'"><option>请选择科室</option></select>';
        tr.appendChild(td6);
        ...
        td8.innerHTML = '<input type="text" size="4" name="nianling'+i+'" id="nianling'+i+'"/>';
        tr.appendChild(td8);

        td9 = document.createElement('td');
        td9.innerHTML = '<select name="xingbie'+i+'" id="xingbie'+i+'"><option>男</option><option>女</option></select>';
        tr.appendChild(td9);
        ...
        td13.innerHTML = '<input type="text" size="8" name="zhilioafei'+i+'" id="zhilioafei'+i+'"/>';
        tr.appendChild(td13);
        ...
        td15.innerHTML = '<input type="text" size="8" name="shoushufei'+i+'" id="shoushufei'+i+'" />';
        tr.appendChild(td15);

        td16 = document.createElement('td');
        td16.innerHTML = '<input type="text" size="8" name="menzhenxiaofei'+i+'" id="menzhenxiaofei'+i+'" />';
        tr.appendChild(td16);
