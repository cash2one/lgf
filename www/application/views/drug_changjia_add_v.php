    ...
    <body id="userlogin_body">
        <form name="subform_changjia" action="<?php echo base_url() . 'index.php/info_add/changjia_add' ?>" method="post">
            <table align="center">
                <tr>
                    <td>厂家id：</td>
                    <td><input type="text" size="17" name="changjia_id" class="k" id="changjia_id" maxlength="20" value=""  placeholder="请点击自动生成……"/></td>
                    <td><input type="button" size="17" name="" value="自动生成" id="" maxlength="20" onclick="changjia_id_gen(this)"/></td>
                </tr>
                <tr>
                    <td>厂家名：</td>
                    <td><input type="text" size="17" name="changjia_name" class="k" id="changjia_name" maxlength="20"/></td>
                </tr>
                <tr>
