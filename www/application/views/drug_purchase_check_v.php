...
<html>
	...
	<script type="text/javascript">
            function get_drug_purchase_list(obj){
//                alert(1);
                var purchase_batch = $(obj).attr("id");
//                alert(purchase_batch);
                $.post("<?php echo base_url() . 'index.php/drug_purchase/get_drug_purchase_list' ?>", {purchase_batch: "" + purchase_batch + ""}, function(data) {
                    if (data.length > 0) {
//                        alert(2);
                        $('#search_auto').show();
        ...
        <!--<form name="drug_pruchase_form">-->
            <table class="drug_purchase_table" id="table1" border="1" align="center">
                ...
                <tr>
                    ...
                    <td width="50" align="center"><a href="#callback" onclick="get_drug_purchase_list(this)" class="cb-trigger" data-toggle="modal" id="<?php echo $val->purchase_batch ;?>"><?php echo $val->purchase_batch ;?></a></td>
	...
	<div class="modal" id="callback" style="top1: 8%;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- /header -->
				<form action="<?php echo base_url() . 'index.php/drug_purchase/drug_purchase_check' ?>" accept-charset="UTF-8" method="post" id="">
					<!-- body -->
				...
				<div class="modal-footer">
                                    <input type="submit" name="op" id="" value="审核" class="btn btn-info" onclick1="drug_purchase_check()">
				</div>
                                </form>	
				<!-- /footer -->
			</div>
