...
//        var_dump($patients);
    ...
    public function patients_zhuyuan_every(){
        $date_every=date('Y-m-d');
        $menzhen_shouru_every = $this->patients_m->zhuyuan_shouru_every_select($date_every);
        $menzhen_shouru_every_sum = $this->patients_m->zhuyuan_shouru_every_select_sum($date_every);
        $zhuyuans= $this->patients_m->zhuyuans_select($date_every);
        $chuyuans = $this->patients_m->chuyuans_select($date_every);
...
//      住院数据统计
        $yujiaokuan=$this->patients_m->zhuyuan_select_yujiaokuan($date_every);
//        var_dump($data['yujiaokuan']);
        $data['yujiaokuan']=0;
        
        if(!empty($yujiaokuan)){
            foreach ($yujiaokuan as $val){
            $data['yujiaokuan']=$data['yujiaokuan'] + $val->yujiaokuan;
            }
        }
...
//        var_dump($patients);
        $data['date_every']=$date_every;
        $this->load->view('patients_zhuyuan_every_v',$data);
    }
